...
public class Tweet {
    ...
    @OneToMany
    @JoinTable(name = "tweets_images", joinColumns = @JoinColumn(name = "tweet_id"), inverseJoinColumns = @JoinColumn(name = "image_id"))
    private Set<TweetImage> images = new HashSet<>();

    @OneToMany
    @JoinTable(name = "tagged_image_users", joinColumns = @JoinColumn(name = "tweet_id"), inverseJoinColumns = @JoinColumn(name = "tagged_image_user_id"))
    private Set<User> taggedImageUsers = new HashSet<>();

    @OneToOne(fetch = FetchType.LAZY)
    @JoinTable(name = "tweet_quotes", joinColumns = @JoinColumn(name = "tweet_id"), inverseJoinColumns = @JoinColumn(name = "quote_tweet_id"))
    private Tweet quoteTweet;

    @OneToOne(fetch = FetchType.LAZY)
    @JoinTable(name = "retweets", joinColumns = @JoinColumn(name = "tweet_id"), inverseJoinColumns = @JoinColumn(name = "retweet_id"))
    ...
    @ManyToMany
    @JoinTable(name = "replies", joinColumns = @JoinColumn(name = "tweet_id"), inverseJoinColumns = @JoinColumn(name = "reply_id"))
    private Set<Tweet> replies = new HashSet<>();

    @OneToMany
    @JoinTable(name = "quotes", joinColumns = @JoinColumn(name = "tweet_id"), inverseJoinColumns = @JoinColumn(name = "quote_id"))
