...
import com.gmail.drack.commons.event.UserEvent;
...
public class UserServiceHandlerImpl implements UserHandlerService {
    ...
    public void handleBlockUser(BlockUserEvent blockUserEvent, String authId) {
        User user = userRepository.findById(blockUserEvent.getId()).orElseGet(() -> createUser(blockUserEvent));
