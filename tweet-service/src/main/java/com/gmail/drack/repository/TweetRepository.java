...
import com.gmail.drack.repository.projection.ProfileTweetImageProjection;
import com.gmail.drack.repository.projection.TweetProjection;
import com.gmail.drack.repository.projection.TweetUserProjection;
...
public interface TweetRepository extends JpaRepository<Tweet, Long> {
    ...
    @Query("""
            ...
            """)
    Page<TweetProjection> getQuotesByTweet(@Param("userId") Long userId, @Param("tweetId") Long tweetId,
            Pageable pageable);
